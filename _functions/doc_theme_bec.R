...
theme_bec <- function(base_size=12, base_family="Helvetica") {
  thm <- theme_bec_foundation(base_size = base_size, base_family = base_family)
  thm
}

theme_bec_facet <- function(base_size = 12, base_family = "Helvetica") {
  
  theme_bec_foundation(base_size = base_size, base_family = base_family) + 
    theme(
...
theme_bec_foundation <- function(base_size, base_family) {
  theme_few(
    base_size = base_size,
